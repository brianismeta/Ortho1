...
function shimOnTrack(window) {
  if (_typeof(window) === 'object' && window.RTCPeerConnection && !('ontrack' in window.RTCPeerConnection.prototype)) {
    ...
    window.RTCPeerConnection.prototype.setRemoteDescription = function setRemoteDescription() {
     if (console) console.log("SET REMOTE DESCRIPTION arg="+JSON.stringify(arguments));
      var _this = this;

      if (!this._ontrackpoly) {
          if (console) console.log("NO ON TRACK POLY");
          this._ontrackpoly = function (e) {
          // onaddstream does not fire when a track is added to an existing
          // stream. But stream.onaddtrack is implemented so we use that.
          if (console) console.log("ON TRACK POLY RUNNING");
          e.stream.addEventListener('addtrack', function (te) {
               if (console) console.log("ADD TRACK POLY RUNNING");
          ...
          e.stream.getTracks().forEach(function (track) {
               if (console) console.log("EACH TRACK POLY RUNNING");
...
function shimAddTrackRemoveTrack(window) {
  ...
  window.RTCPeerConnection.prototype.setLocalDescription = function setLocalDescription() {
     if (console) console.log("SET LOCAL DESCRIPTION arg="+JSON.stringify(arguments));
...
function shimPeerConnection(window) {
  ...
  if (console) console.log("Browser details version: "+ browserDetails.version);
  ...
  window.RTCPeerConnection.prototype.addIceCandidate = function addIceCandidate() {
     if (console) console.log("ADD ICE CANDIDATE ");
     if (!arguments[0]) {
      if (arguments[1]) {
...
function fixNegotiationNeeded(window) {
     if (console) console.log("FIX NEGOTATION ");
...
function filterIceServers(iceServers, edgeVersion) {
     if (console) console.log("FILTER ICE SERVERS ");
  var hasTurn = false;
...
function () {
  ...
  Logger.prototype.log = function () {
    ...
    args[0] = MiscUtilities.dateHelper(new Date()).formatPadded + ": ";
...
function (_super) {
  ...
  Socket.prototype.start = function (id, token) {
    ...
    this._socket.onmessage = function (event) {
      ...
      logger_1.default.log("Emitting data:", data);
  ...
  Socket.prototype._sendQueuedMessages = function () {
    ...
    logger_1.default.log("_sendQueuedMessages.  Queue length is " + copiedQueue.length);
  ...
  Socket.prototype.send = function (data) {
    ...
    if (!this._id) {
     logger_1.default.log("Pushing send message onto queue.  Message is " + data + ". Queue length is " + this._messagesQueue.length);
    ...
    if (!data.type) {
     logger_1.default.error("Invalid message!");
      this.emit(enums_1.SocketEventType.Error, "Invalid message");
      return;
    }

    if (!this._wsOpen()) {
     logger_1.default.error("Websocket not open!");
      return;
    }

    var message = JSON.stringify(data);

    logger_1.default.log("Sending message on socket: " + message);
...
if (console) console.log("NEGOTIATOR START CONNECTION: MAKE OFFER");
      this._makeOffer();
    } else {
  ...
  Negotiator.prototype._setupListeners = function (peerConnection) {
    ...
    peerConnection.onicecandidate = function (evt) {
     logger_1.default.log("ON-ICE-CANDIDATE event triggered!");
    ...
    peerConnection.onicecandidateerror = function (evt) {
     logger_1.default.log("ON-ICE-CANDIDATE ERROR!" + JSON.stringify(evt));
    };

    peerConnection.oniceconnectionstatechange = function () {
     logger_1.default.log("ON-ICE-CANDIDATE state change!  State is " + peerConnection.iceConnectionState);
      switch (peerConnection.iceConnectionState) {
        ...
        case "completed":
          logger_1.default.log("onIceConnectionState RESET TO NULL");
  ...
  Negotiator.prototype.cleanup = function () {
    ...
    logger_1.default.log("onIceConnectionState RESET TO EMPTY FUNCTION");
  ...
  Negotiator.prototype._makeOffer = function () {
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
               logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 0: Init some stuff and fall through.");
          ...
          case 1:
            ...
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 1: Create offer.");
            return [4
            /*yield*/
          ...
          case 2:
            offer = _a.sent();
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 2: Set Offer SDP and fall through.");
          ...
          case 3:
            _a.trys.push([3, 5,, 6]);
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 3: Set local description.");
          ...
          case 4:
            ...
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 4: Send offer:", offer, "for:" + this.connection.peer);
            payload = {
              sdp: offer,
          ...
          case 5:
            ...
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 5: Some kind of error handling");
          ...
          case 6:
               logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 6: MYSTERY");
               return [3
            /*break*/
            , 8];
          ...
          case 7:
            err_1_1 = _a.sent();
            logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 7: More error handling");
          ...
          case 8:
               logger_1.default.log("NEGOTIATOR MAKE OFFER CASE 8: MYSTERY");
               return [2
            /*return*/
            ];
        }
  ...
  Negotiator.prototype._makeAnswer = function () {
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 0: Init some stuff and fall through.");
            peerConnection = this.connection.peerConnection;
            provider = this.connection.provider;
            _a.label = 1;

          case 1:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 1: Create answer.");
               _a.trys.push([1, 7,, 8]);
          ...
          case 2:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 2: Set Answer SDP and fall through.");
               answer = _a.sent();
          ...
          case 3:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 3: Set local description.");
               _a.trys.push([3, 5,, 6]);
          ...
          case 4:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 4: Send answer:", answer, "for:" + this.connection.peer);
               _a.sent();

            logger_1.default.log("Sending Answer");
            provider.socket.send({
          ...
          case 5:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 5: Some kind of error handling");
               err_3 = _a.sent();
          ...
          case 6:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 6: MYSTERY");
            return [3
            /*break*/
            , 8];

          case 7:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 7: More error handling");
               err_1_2 = _a.sent();
          ...
          case 8:
               logger_1.default.log("NEGOTIATOR MAKE ANSWER CASE 8: MYSTERY");
            return [2
            /*return*/
            ];
        }
